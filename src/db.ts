/**
 * SQLite database access layer for the India TRAI Telecom Regulation MCP server.
 *
 * Schema:
 *   - frameworks  — TRAI regulation categories
 *   - controls    — Individual regulations and directions within each category
 *   - circulars   — TRAI directions, orders, and notices
 *
